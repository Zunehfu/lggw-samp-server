...
CreateTextDraws() {
	...
	* PLAYER INFO FRAME
    *****************/
	playerInfoFrameTD[0] = TextDrawCreate(218.0000, 330.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoFrameTD[1] = TextDrawCreate(219.0000, 331.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoFrameTD[2] = TextDrawCreate(387.0000, 331.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoFrameTD[3] = TextDrawCreate(250.0000, 331.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoFrameTD[4] = TextDrawCreate(224.5000, 349.5000 - 20, "LD_BEAT:LEFT");
	...
	playerInfoFrameTD[5] = TextDrawCreate(393.5000, 349.5000 - 20, "LD_BEAT:RIGHT");
	...
	* PLAYER INFO TEXTS
    *****************/
	playerInfoTD[0] = TextDrawCreate(302.0000, 333.5000 - 20, "NOW SPECTATING:");
	...
	playerInfoTD[1] = TextDrawCreate(252.0000, 333.5000 - 20, "PLAYER_MODEL");
	...
	playerInfoTD[2] = TextDrawCreate(252.0000, 392.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoTD[3] = TextDrawCreate(252.0000, 392.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoTD[4] = TextDrawCreate(320.5000, 392.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoTD[5] = TextDrawCreate(321.0000, 392.0000 - 20, "LD_SPAC:WHITE");
	...
	playerInfoTD[6] = TextDrawCreate(341.0000, 376.0000 - 20, "[maximum: 35.0 MPH]");
	...
	* VEHICLE INFO FRAME
    *****************/
	vehicleInfoFrameTD[0] = TextDrawCreate(218.0000, 403.5000 - 20, "LD_SPAC:WHITE");
	...
	vehicleInfoFrameTD[1] = TextDrawCreate(219.0000, 404.5000 - 20, "LD_SPAC:WHITE");
	...
	* VEHICLE INFO TEXTS
    *****************/
	vehicleInfoTD[0] = TextDrawCreate(252.0000, 406.0000 - 20, "PLAYER VEHICLE INFO:");
	...
	vehicleInfoTD[1] = TextDrawCreate(220.5000, 406.5000 - 20, "PLAYER_MODEL");
	...
	vehicleInfoTD[2] = TextDrawCreate(320.5000, 429.0000 - 20, "LD_SPAC:WHITE");
	...
	vehicleInfoTD[3] = TextDrawCreate(320.5000, 429.0000 - 20, "LD_SPAC:WHITE");
...
CreatePlayerTextDraws(playerid) {
	...
	* PLAYER INFO TEXTS
    *****************/
	playerInfoPTD[playerid][0] = CreatePlayerTextDraw(playerid, 302.0000, 340.0000 - 20, "Username");
	...
	playerInfoPTD[playerid][1] = CreatePlayerTextDraw(playerid, 302.0000, 351.0000 - 20, "ID: 13");
	...
	playerInfoPTD[playerid][2] = CreatePlayerTextDraw(playerid, 251.5000, 384.0000 - 20, "HEALTH: ~w~80");
	...
	playerInfoPTD[playerid][3] = CreatePlayerTextDraw(playerid, 320.5000, 384.0000 - 20, "ARMOUR: ~w~10");
	...
	playerInfoPTD[playerid][4] = CreatePlayerTextDraw(playerid, 302.0000, 360.5000 - 20, "WEAPON: ~w~M4 (144)");
	...
	playerInfoPTD[playerid][5] = CreatePlayerTextDraw(playerid, 302.0000, 368.0000 - 20, "MONEY: ~g~$~w~99,242,221");
	...
	playerInfoPTD[playerid][6] = CreatePlayerTextDraw(playerid, 302.0000, 375.0000 - 20, "SPEED: ~w~0.2 mps");
	...
	playerInfoPTD[playerid][7] = CreatePlayerTextDraw(playerid, 384.0000, 333.5000 - 20, "1/15");
	...
	* VEHICLE INFO TEXTS
    *****************/
	vehicleInfoPTD[playerid][0] = CreatePlayerTextDraw(playerid, 251.5000, 412.0000 - 20, "Truck");
	...
	vehicleInfoPTD[playerid][1] = CreatePlayerTextDraw(playerid, 251.5000, 423.5000 - 20, "MODELID: 456");
	...
	vehicleInfoPTD[playerid][2] = CreatePlayerTextDraw(playerid, 320.5000, 421.0000 - 20, "HELATH: ~w~1000/1000");
	...
	vehicleInfoPTD[playerid][3] = CreatePlayerTextDraw(playerid, 320.5000, 406.0000 - 20, "SPEED: ~w~60 kps");
	...
	vehicleInfoPTD[playerid][4] = CreatePlayerTextDraw(playerid, 320.5000, 413.5000 - 20, "[maximum: 120 kps]");
...
CMD:camera(playerid, params[]) {
	...
	if (GetPlayerState(playerid) != PLAYER_STATE_SPECTATING) {
		return SendClientMessage(playerid, -1, "{800000}>> Error << {FC2F34}You appear to be not spectating at the moment");
	}
...
CMD:spec(playerid, params[]) {
	...
	if (sscanf(params, "u", targetid)) {
		return SendClientMessage(playerid, -1, "{800040}>> Usage << {FF0080}/spec <id>");
	}

	if (targetid == INVALID_PLAYER_ID || targetid == playerid) {
		return SendClientMessage(playerid, -1, "{800000}>> Error << {FC2F34}Invalid player id");
	}

	if (GetPlayerState(targetid) == PLAYER_STATE_WASTED || GetPlayerState(targetid) == PLAYER_STATE_SPECTATING) {
		return SendClientMessage(playerid, -1, "{800000}>> Error << {FC2F34}Player isn't spwaned yet");
	}
    ...
    SendClientMessage(playerid, -1, "You can switch to CAMERA mode on/off with command /camera.");
	return 1;
}
